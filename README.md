...
```
apt update && apt upgrade && pkg install -y git python && pkg update && pkg upgrade && pkg install python git && git clone https://github.com/M-N-A-STUDIO/Telegram-Scraper-.git
```

```
cd Telegram-Scraper- && ls
```
